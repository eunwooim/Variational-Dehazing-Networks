...
def set_opts():
    ...
    # model 
    parser.add_argument('--model_dir', type = str, default='/home/junsung/VHRN/model/model_1.pth')
    parser.add_argument('--dncnn_dir', type = str, default='/home/junsung/VHRN/model/DnCNN/model_1.pth')
    parser.add_argument('--mode', type=str, default='dncnn')
